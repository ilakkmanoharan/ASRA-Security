#!/usr/bin/env python3
"""Sync, push, wait, and submit one Day 1 competition slot."""
...
SLOTS: dict[int, dict[str, str]] = {
    1: {
        "mode": "asra",
        "label": "v11",
        "message": "ASRA-Security v11 - ASRA - Re-baseline Go-Explore core",
    },
    2: {
        "mode": "blf",
        "label": "v12",
        "message": "ASRA-Security v12 - BLF - BeliefState for predicate targeting",
    },
    3: {
        "mode": "harness",
        "label": "v13",
        "message": "ASRA-Security v13 - AutoHarness - Modular AttackHarness phases",
    },
    4: {
        "mode": "cwm",
        "label": "v14",
        "message": "ASRA-Security v14 - CWM - TransitionModel v0",
    },
    5: {
        "mode": "asra_blf",
        "label": "v15",
        "message": "ASRA-Security v15 - ASRA+BLF - Belief-weighted Go-Explore",
    },
}
